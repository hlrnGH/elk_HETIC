...
| ---------------- | ----------------------- | ------------------------------------------------------------------------------------ |
| Nassim Benchikh  | Lead & Data             | F4 - Mapping, F5 - Requêtes, F7 - Documentation, F8 Moteur de recherche              |
...
| #7  | feature/Project-Report       | Rapport docsx                                     | Nassim/Rodrygue        | Mergée dans dev  |
| #8  | feature/search-engine        | Mini moteur de recherche + demo                   | Nassim/Harold/Rodrygue | Mergée dans dev  |
