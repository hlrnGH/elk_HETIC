...
| ---------------- | ----------------------- | ----------------------------------------------------------------------------- |
| Nassim Benchikh  | Lead & Data             | F4 - Mapping, F5 - Requêtes DSL, F7 - Documentation, F8 - Moteur de recherche |
| Harold Lerner    | Infrastructure & Moteur | F1 - Bootstrap stack, F2 - Ingestion brute, F3 - Nettoyage                    |
| Rodrigue Harnais | Dashboard               | F6 - Dashboard Kibana, F7 - Documentation, F8 - Moteur de recherche           |
...
| #7  | feature/moteur-recherche     | Mini moteur de recherche + demo                   | Nassim/Rodrygue  | Mergée dans dev  |
| #8  | feature/project-report       | Rapport documentation                             | Rodrygue         | Mergée dans dev  |
