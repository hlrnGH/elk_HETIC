...
Après réalisation, cette tâche s’est révélée plus simple que prévu dans le cadre du projet.
...
| -------- | ----------------------------------------------------------------------------------------------------- |
| Harold   | F1 Bootstrap, F2 Ingestion brute, F3 Nettoyage & normalisation,F8 Moteur de recherche                 |
| Nassim   | F4 Mapping & qualité, F5 Requêtes analytiques, F7 documentation avec Rodrigue, F8 Moteur de recherche |
| Rodrigue | F6 Dashboard Kibana lié aux requetes F5, F7 documentation avec Nassim, F8 Moteur de recherche         |
